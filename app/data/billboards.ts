...
export const billboards: Record<string, BillboardData> = {
  ...
  "bangsaen-galaxy-junction": {
    ...
    specs: [
      ...
      { label: "Operating Hours", value: "05:30 – 00:00" },
    ],
    locationStory: "แยกที่รถทุกคันต้องหยุดรอไฟแดงก่อนลงหาดบางแสน ป้ายตรงนี้คือสิ่งแรกที่นักท่องเที่ยวเห็นก่อนถึงชายหาด",
    audienceStory: "นักท่องเที่ยวสุดสัปดาห์, นักศึกษามหาวิทยาลัยบูรพา และชุมชนท้องถิ่นแสนสุข รวมกว่า 42,000 คนต่อวัน",
  ...
  "bangsaen-tech-college": {
    ...
    specs: [
      ...
      { label: "Loop Length",     value: "15 Seconds" },
      { label: "Total Spots",     value: "8 Shared" },
      { label: "Operating Hours", value: "05:30 – 22:00" },
    ],
  ...
  "chonburi-tech-college-sukhumvit": {
    ...
    specs: [
      ...
      { label: "Operating Hours", value: "05:30 – 23:30" },
    ],
  ...
  "sriracha-robinson-junction": {
    ...
    specs: [
      ...
      { label: "Loop Length",     value: "15 Seconds" },
      { label: "Total Spots",     value: "10 Shared" },
      { label: "Operating Hours", value: "05:00 – 01:00" },
    ],
  ...
  "pattaya-dolphin-roundabout": {
    ...
    specs: [
      ...
      { label: "Loop Length",     value: "15 Seconds" },
      { label: "Total Spots",     value: "10 Shared" },
      { label: "Operating Hours", value: "00:00 – 24:00" },
    ...
    audienceStory: "นักท่องเที่ยวไทยและต่างชาติจากทั่วโลก คนงาน ผู้อยู่อาศัยในพัทยา รวมกว่า 120,000 คนต่อวัน",
